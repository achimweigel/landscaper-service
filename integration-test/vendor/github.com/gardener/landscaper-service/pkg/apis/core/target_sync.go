...
type TargetSyncSpec struct {
	...
	// NamespaceExpression defines the namespaces in which targets with the synced secrets are created via a regular
	// expression according to https://github.com/google/re2/wiki/Syntax
	NamespaceExpression string `json:"namespaceExpression"`
}
